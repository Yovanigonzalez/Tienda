        ...
        <section class="content">
            <div class="container-fluid">
              ...
              if (isset($_GET['success']) && $_GET['success'] == 1) {
                  echo "<div class='alert alert-success'>Suscriptor eliminado correctamente.</div>";
              }
              ?>
                ...
                <tbody>
                  ...
                  // Consulta SQL para obtener suscriptores
                  $sql = "SELECT id, email FROM suscriptores";
                  $result = $conn->query($sql);

                  // Mostrar resultados de la consulta
                  while ($row = $result->fetch_assoc()) {
                    echo "<tr><td>" . $row["email"] . "</td>";
                    echo "<td><a href='eliminar_suscriptor.php?id=" . $row["id"] . "' class='btn btn-danger btn-sm'><i class='fas fa-trash'></i> Eliminar</a></td></tr>";
                  }
